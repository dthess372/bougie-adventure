        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-12">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="space-y-4">
              <a href="mailto:info@bougieadventure.com" className="flex items-center gap-3 text-sm text-charcoal/80 hover:text-gold transition-colors group">
              ...
              <a href="mailto:laurel@bougieadventure.com" className="flex items-center gap-3 text-sm text-charcoal/80 hover:text-gold transition-colors group">
                <div className="w-10 h-10 rounded-full bg-pink flex items-center justify-center group-hover:bg-gold/10 transition-colors">
                  <Mail size={16} className="text-royal-blue" />
                </div>
                laurel@bougieadventure.com
              </a>
              <a href="mailto:nicole@bougieadventure.com" className="flex items-center gap-3 text-sm text-charcoal/80 hover:text-gold transition-colors group">
                <div className="w-10 h-10 rounded-full bg-pink flex items-center justify-center group-hover:bg-gold/10 transition-colors">
                  <Mail size={16} className="text-royal-blue" />
                </div>
                nicole@bougieadventure.com
              </a>
              <a href="https://instagram.com/bougieadventure" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-sm text-charcoal/80 hover:text-gold transition-colors group">
                <div className="w-10 h-10 rounded-full bg-pink flex items-center justify-center group-hover:bg-gold/10 transition-colors">
